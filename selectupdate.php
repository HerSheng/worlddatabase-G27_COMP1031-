...
<td><a class="w3-button w3-light-green" href="update.php?CityID=<?php echo escape($row["CityID"]);?>">Edit</a></td>
      </tr>
    <?php } ?>
      </tbody>
  </table>
...
<h2>Find City Based On Country Code</h2>
...
<button class="w3-button w3-yellow" onclick="document.location = 'selectupdate2.php'">Update Country</button></p>
